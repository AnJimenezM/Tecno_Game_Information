...
<head>
    ...
    <title>Acerca de la pagina</title>
</head>
<body class="gradient">
    ...
    <header>
        <nav class="logotipo">
            <ul>
                <li ><a class="cuenta"  href="formularioregistro.php">iniciar sesion</a></li>
            </ul>
            
            <ul class="menu1" id="menu1">
                
                
                <li><a href="index.php">Inicio<span><i class='bx bxs-home'></i></span></a></li>
